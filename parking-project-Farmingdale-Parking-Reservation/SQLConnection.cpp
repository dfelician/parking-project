...
void ConnectToDB::lot01Proc() {

	SQLHANDLE SQLEnvHandle = NULL;
	SQLHANDLE SQLConnectionHandle = NULL;
	SQLHANDLE SQLStatementHandle = NULL;
	SQLRETURN retCode = 0;
	std::string SQLQuery = "exec updateLot01Proc";
	...
	do {
		...
		if (SQL_SUCCESS != SQLExecDirect(SQLStatementHandle, (SQLCHAR*)SQLQuery.c_str(), SQL_NTS)) {
			...
			std::cout << "Lot01 Updated" << std::endl;
		}
	} while (FALSE);
...
void ConnectToDB::lot02Proc() {

	SQLHANDLE SQLEnvHandle = NULL;
	SQLHANDLE SQLConnectionHandle = NULL;
	SQLHANDLE SQLStatementHandle = NULL;
	SQLRETURN retCode = 0;
	std::string SQLQuery = "exec updateLot02Proc";
	...
	do {
		...
		if (SQL_SUCCESS != SQLExecDirect(SQLStatementHandle, (SQLCHAR*)SQLQuery.c_str(), SQL_NTS)) {
			...
			std::cout << "Lot02 Updated" << std::endl;
		}
	} while (FALSE);
...
void ConnectToDB::lot03Proc() {

	SQLHANDLE SQLEnvHandle = NULL;
	SQLHANDLE SQLConnectionHandle = NULL;
	SQLHANDLE SQLStatementHandle = NULL;
	SQLRETURN retCode = 0;
	std::string SQLQuery = "exec updateLot03Proc";
	...
	do {
		...
		if (SQL_SUCCESS != SQLExecDirect(SQLStatementHandle, (SQLCHAR*)SQLQuery.c_str(), SQL_NTS)) {
			...
			std::cout << "Lot03 Updated" << std::endl;
		}
	} while (FALSE);
...
void ConnectToDB::morningProc() {

	SQLHANDLE SQLEnvHandle = NULL;
	SQLHANDLE SQLConnectionHandle = NULL;
	SQLHANDLE SQLStatementHandle = NULL;
	SQLRETURN retCode = 0;
	std::string SQLQuery = "exec MorningAdminProcedure";
